...
fn decode_into_array(
	reader: &mut ReaderInfo,
	shared_x: &mut Vec<i64>,
	y_datas: &mut Vec<Vec<f32>>,
) {
	let ReaderInfo {
		dataset_id: _,
		read_state,
